<div class="row" id="cari-mitra" style="margin-left: 0; margin-right: 0;">
...
<div style="padding-left: 3%;">
    <div class="row" style="margin-left: 0; margin-right: 0;">
        ...
        <div class="card cust-ran2" style="width: 18rem; padding: 2%; margin: 0.5%">
            <img class="card-img-top cust-img3" src="<?php echo base_url()?>/img/Users/<?php echo $item['user_pic']; ?>"
                alt="">
            <div class="card-body card-cust2 text-center">
                ...
                <a href="<?php echo base_url()?>index.php/homectl/viewUser/<?php echo $item['user_id']?>"
                    class="btn cust-button4 font-weight-bold " style="color:#F69E7B">Lihat Bisnis</a>
            </div>
        </div>
        <?php
        } 
