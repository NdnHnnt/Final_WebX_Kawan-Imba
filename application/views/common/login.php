...
<div>
  ...
  <div class="form-group row">
                    <label for="inputEmail" class="col-sm-3 col-form-label cust-form-label">Email Bisnis<span
                            style="color:red">*</span></label>
                    <div class="col-sm-9">
                        <input type="email" class="form-control form-control-lg cust-form-input" name="email" id="email"
                            placeholder="E-mail Bisnis" required="required">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="inputPassword" class="col-sm-3 col-form-label cust-form-label">Kata Sandi<span
                            style="color:red">*</span></label>
                    <div class="col-sm-9">
                        <input type="password" class="form-control form-control-lg cust-form-input" name="password" id="password"
